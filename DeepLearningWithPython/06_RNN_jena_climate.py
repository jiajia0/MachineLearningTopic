# @Time    : 2019/7/8 10:43
# @Author  : Leafage
# @File    : 06_RNN_jena_climate.py
# @Software: PyCharm
# @Describe: RNN的高级用法，预测jena的天气
import os
import numpy as np
...
fname = r'F:\GitRepository\MachineLearningNote\DeepLearningWithPython\datasets\jena_climate_2009_2016.csv'
f = open(fname)
data = f.read()
f.close()
